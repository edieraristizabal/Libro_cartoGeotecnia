...
futuro en una área específica. En el mismo sentido, {cite:t}`Soeteres1996` define susceptibilidad como la posibilidad de que un
...
A continuación se abordará cada uno de estos pasos.
